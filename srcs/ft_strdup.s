...
_ft_strdup:
	...
	mov [rbp - 8], rdi			; push rdi address on rbp - 8
	call _ft_strlen				; get string length
	mov [rbp - 16], rax			; push rax address on rbp - 16
	mov rdi, rax				; give string length to malloc
	call _malloc				; call malloc
	mov rdi, rax				; put the result of malloc into first parameter
	mov rsi, [rbp - 8]			; pop back default string into rsi register
	mov rdx, [rbp - 16]			; pop back string length into rdx register	
